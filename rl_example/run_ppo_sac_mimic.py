...
parser.add_argument('--log', type=str, default='garbage_ppo_sac_mimic',
                    help='Directory name of log.')
parser.add_argument('--env_name', type=str,
                    default='RoboschoolPremaidAIMimicWalker-v0', help='Name of environment.')
